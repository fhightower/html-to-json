...
coverage: ## check code coverage quickly with the default Python
	coverage run --source html_to_json -m pytest
...
docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/html_to_json.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ html_to_json
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
upstream: ## set the upstream for the repository
	git remote set-upstream https://github.com/fhightower/html_to_json.git
